...
const drag = (state = dragInitialState, action) => {
    switch(action.type) {
        ...
        case SOURCE_DRAG_END:{
            ...
            let screenWidth=state.layout.screenWidth;
            if(screenWidth<1080) screenWidth=1080;
            let bojung=screenWidth-state.layout.right-state.layout.left;
            ...
            return Object.assign({},state,{
                boxList:Object.assign({},state.boxList,{
                        [state.idCount++]:{
                            ...
                            left:targetSourceBox.left+action.x-targetSourceBox.x+bojung,
