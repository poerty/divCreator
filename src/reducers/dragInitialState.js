...
export const boxSourceInitialState = Map({
...
export const componentSourceInitialState = Map({
  ids: List(['2001', '2002']),
  byId: Map({
    2001: Map({
      id: '2001',
      ...
      childIds: List([]),
      dragImgSrc: './img/1.png',
      propList: Map({ width: 100, height: 100, color: 'gray' }),
    }),
    2002: Map({
      id: '2002',
...
export const dragInitialState = Map({
  ...
  boxSourceList: boxSourceInitialState,
  componentSourceList: componentSourceInitialState,
